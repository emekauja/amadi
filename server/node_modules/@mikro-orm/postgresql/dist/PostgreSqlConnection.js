...
// @ts-ignore
const tablecompiler_js_1 = __importDefault(require("knex/lib/dialects/postgres/schema/tablecompiler.js"));
// @ts-ignore
const tablecompiler_js_2 = __importDefault(require("knex/lib/schema/tablecompiler.js"));
...
class PostgreSqlConnection extends knex_1.AbstractSqlConnection {
    ...
    patchKnex() {
        ...
        const that = this;
        tablecompiler_js_1.default.prototype.addColumns = function (columns, prefix, colCompilers) {
            if (prefix !== this.alterColumnsPrefix) {
                // base class implementation for normal add
                return tablecompiler_js_2.default.prototype.addColumns.call(this, columns, prefix);
            }
            // alter columns
